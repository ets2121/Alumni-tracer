    ...
    <table class="min-w-full leading-normal">
        ...
        <tbody>
            @forelse($courses as $course)
                <tr>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm font-medium text-gray-900 uppercase">
                        {{ $course->code }}
                    </td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-gray-700">
                        <div class="font-bold">{{ $course->name }}</div>
                        <div class="text-xs text-gray-400 line-clamp-1">{{ $course->description }}</div>
                    </td>
