<x-layouts.admin>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div
            ...
            <h3 class="text-gray-500 dark:text-dark-text-muted text-sm font-bold uppercase tracking-wider">Total Alumni
            </h3>
            <p class="text-4xl font-black text-brand-600 mt-2">{{ number_format($stats['total_alumni']) }}</p>
        </div>
        <div
            class="bg-white dark:bg-dark-bg-elevated border border-gray-100 dark:border-dark-border rounded-2xl shadow-sm p-6">
            <h3 class="text-gray-500 dark:text-dark-text-muted text-sm font-bold uppercase tracking-wider">Pending</h3>
            <p class="text-4xl font-black text-amber-500 mt-2">{{ number_format($stats['pending_alumni']) }}</p>
        </div>
        <div
            class="bg-white dark:bg-dark-bg-elevated border border-gray-100 dark:border-dark-border rounded-2xl shadow-sm p-6">
            <h3 class="text-gray-500 dark:text-dark-text-muted text-sm font-bold uppercase tracking-wider">News & Events
            </h3>
    ...
    <div
        class="bg-white dark:bg-dark-bg-elevated overflow-hidden shadow-sm sm:rounded-lg border dark:border-dark-border">
