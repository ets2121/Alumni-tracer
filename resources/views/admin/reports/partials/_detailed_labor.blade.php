<div class="space-y-6">
    ...
    <div class="flex items-center justify-between pb-8 border-b-2 border-gray-900 dark:border-dark-border mb-8">
        <div class="flex items-center gap-4">
            <div
                class="w-12 h-12 bg-gray-900 dark:bg-dark-bg-subtle rounded-xl flex items-center justify-center text-white dark:text-dark-text-primary shadow-lg dark:shadow-none">
