...
<div class="space-y-8" x-data="{ subTab: 'all' }">
    ...
    <!-- Summary KPI Strip -->
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 animate-in fade-in duration-700">
        <div
            ...
            <p class="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1">Registrants</p>
        ...
        <div
            class="bg-white dark:bg-dark-bg-elevated p-4 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] border border-gray-100 dark:border-dark-border shadow-sm col-span-2">
