<div class="space-y-8">
    ...
    @foreach($data as $status => $profiles)
        <div class="mb-10">
            ...
            <table
                class="w-full border-collapse bg-white dark:bg-dark-bg-elevated border border-gray-100 dark:border-dark-border rounded-2xl overflow-hidden shadow-sm dark:shadow-none">
                <thead>
