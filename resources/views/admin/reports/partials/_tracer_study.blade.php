<div class="space-y-8">
    ...
    <div class="flex items-center justify-between pb-8 border-b-2 border-gray-900 mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-xl font-black uppercase tracking-widest text-gray-900">CHED Tracer Study</h1>
                <p class="text-[9px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-0.5">Graduate Monitoring & Performance Record</p>
            </div>
        </div>
        <div class="text-right">
            <p class="text-[9px] font-black text-gray-400 uppercase tracking-widest leading-tight">Generated by: {{ Auth::user()->name }}</p>
