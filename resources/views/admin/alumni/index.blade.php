        ...
        <div x-show="deleteModalOpen" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="modal-content-container sm:max-w-md sm:w-full text-center" x-show="deleteModalOpen"
                    ...
                    <h3 class="text-2xl font-black text-gray-900 mb-2">Delete Record?</h3>
                    <p class="text-sm text-gray-500 mb-8 px-4">Remove <span class="font-bold text-gray-800"
                            x-text="itemToDelete"></span> from records? This cannot be undone.</p>
                    ...
                    async executeDelete() {
                        try {
                            ...
                            if (response.ok) {
                                ...
                                this.fetchData();
                                this.showFlash('Record deleted successfully.');
                            }
