...
// Verification Routes
Route::post('verification/send', [App\Http\Controllers\VerificationController::class, 'sendCode'])->name('otp.send');
Route::post('verification/verify', [App\Http\Controllers\VerificationController::class, 'verifyCode'])->name('otp.verify');
...
Route::middleware(['auth', 'status'])->group(function () {
    ...
    Route::middleware('admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('chat-management/banned-words/toggle', [App\Http\Controllers\Admin\ChatManagementController::class, 'toggleBannedWords'])->name('chat-management.banned-words.toggle');
